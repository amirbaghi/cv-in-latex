...
% Set the version of the document to compile
\booltrue{FullVersion}
% \boolfalse{FullVersion}
...
\name{Amir Masood}{Baghi}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{Uppsala, Sweden}

\mobile{+46 73 971 61 88}
\email{bamirmasoud@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/amirbaghi}
\linkedin{linkedin.com/in/amir-masoud-baghi}
% \gitlab{gitlab-id}
...
%-------------------------------------------------------------------------------
\ifbool{FullVersion}{\input{cv/summary.tex}}{}
\input{cv/education.tex}
\input{cv/experience.tex}
\input{cv/academic_experience.tex}
\input{cv/projects.tex}
\ifbool{FullVersion}{\input{cv/affiliations.tex}}{}
\input{cv/awards_honors.tex}
\ifbool{FullVersion}{\input{cv/certs.tex}}{}
\input{cv/skills.tex}
