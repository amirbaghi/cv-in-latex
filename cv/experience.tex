  ...
  \cventry
    ...
    {\textbf{Sept 2021 - Aug 2022}} % Date(s)
    {
      \ifbool{FullVersion}{
        ...
        \begin{cvitems}
            \item {Got accepted for an internship position in an active publishing and development studio}
            \item {Worked as an \emph{Unity game developer} in the hyper-casual game development department}
            \item {Additionally participated in game design tasks such as \emph{idea development and refinement}}
            \item {My team and I made \emph{four complete casual/hyper-casual mobile games} among other activities}
        \end{cvitems}
      }
    }
