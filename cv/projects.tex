...
%---------------------------------------------------------
     ...
     \ifbool{FullVersion}{
       \cventry
        ...
        {
            Five types of classifiers and a neural network were developed with advanced hyper-tuning for prediction of the lead actor's gender based on a script's attributes. Done in Python using PyTorch, RayTune, and scikit-learn.
        }
     }{}
  ...
  \cventry
    ...
    {Raytracing and Environment and Shadow Mapping For a Model Viewer} % Project
    {\textbf{Uppsala, Sweden}} % Location
    {\textbf{Spring 2023}} % Date(s)
    {
