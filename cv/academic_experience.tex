...
%---------------------------------------------------------
  ...
  \cventry
    ...
    {Shiraz, Iran} % Location
    {Fall 2021 (Fourth Year of Bachelor’s)} % Date(s)
    {
    ...
    {Shiraz, Iran} % Location
    {Spring 2021 (Third Year of Bachelor’s)} % Date(s)
    {
    ...
    {Shiraz, Iran} % Location
    {Fall 2020 (Third Year of Bachelor’s)} % Date(s)
    {
    ...
    {Shiraz, Iran} % Location
    {Spring 2020 (Second Year of Bachelor’s)} % Date(s)
    {
    ...
    {Shiraz, Iran} % Location
    {Fall 2019 (Second Year of Bachelor’s)} % Date(s)
    {
